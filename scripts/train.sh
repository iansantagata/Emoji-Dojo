#! /bin/bash
#
# This script creates an animated GIF of an input image that appears to move from one side of the frame
...
display_help()
{
    ...
    echo "Create an animated GIF of an input image in FILE that appears to move from one side of the frame across to the opposite side repeatedly in a loop, like a train or a Conga line."
    echo
    echo "OPTIONS:"
